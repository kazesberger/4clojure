...
var G__73845 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__73845;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__73846 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__73846,ch);
...
if(("\\" === ch__$1)){
var ch_73847__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_73847__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_73847__$2);
} else {
}

var G__73848 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__73848;
continue;
}
}
...
var vec__73856 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__73856,(0),null);
var start_column = cljs.core.nth.call(null,vec__73856,(1),null);
...
var G__73859 = cljs.core.conj_BANG_.call(null,a,form);
a = G__73859;
continue;
}
}
...
var _STAR_read_delim_STAR_73860 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_73860;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__73861 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__73861,(0),null);
var start_column = cljs.core.nth.call(null,vec__73861,(1),null);
...
var vec__73864 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__73864,(0),null);
var end_column = cljs.core.nth.call(null,vec__73864,(1),null);
...
var vec__73867 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__73867,(0),null);
var start_column = cljs.core.nth.call(null,vec__73867,(1),null);
...
var vec__73870 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__73870,(0),null);
var end_column = cljs.core.nth.call(null,vec__73870,(1),null);
...
var vec__73873 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__73873,(0),null);
var start_column = cljs.core.nth.call(null,vec__73873,(1),null);
...
var vec__73876 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__73876,(0),null);
var end_column = cljs.core.nth.call(null,vec__73876,(1),null);
...
var sb = (function (){var G__73879 = (new goog.string.StringBuffer());
G__73879.append(initch);
...
var G__73881 = (function (){var G__73880 = sb;
G__73880.append(ch);

return G__73880;
})();
var G__73882 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__73881;
ch = G__73882;
continue;
}
...
switch (G__73885) {
case "\\":
var G__73889 = (function (){var G__73886 = sb;
G__73886.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__73886;
})();
var G__73890 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__73889;
ch = G__73890;
continue;
...
break;
default:
var G__73891 = (function (){var G__73887 = sb;
G__73887.append(ch);

return G__73887;
})();
var G__73892 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__73891;
ch = G__73892;
continue;
...
var vec__73893 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__73893,(0),null);
var end_column = cljs.core.nth.call(null,vec__73893,(1),null);
...
var vec__73896 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__73896,(0),null);
var column = cljs.core.nth.call(null,vec__73896,(1),null);
...
var vec__73901 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__73901,(0),null);
var column = cljs.core.nth.call(null,vec__73901,(1),null);
...
var vec__73906 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__73906,(0),null);
var column = cljs.core.nth.call(null,vec__73906,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__73911 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__73911,(0),null);
var start_column = cljs.core.nth.call(null,vec__73911,(1),null);
...
var vec__73914 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__73914,(0),null);
var end_column = cljs.core.nth.call(null,vec__73914,(1),null);
...
var G__73917 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__73917,true,null,opts,pending_forms);
...
var G__73918 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__73918)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__73918)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__73918)){
...
var _STAR_suppress_read_STAR_73919 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_73919;
}});
...
var G__73920 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__73920,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__73920,rdr,first_line);
...
var G__73924 = matched;
var G__73925 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__73924;
finished = G__73925;
continue;
} else {
...
var _STAR_suppress_read_STAR_73926 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_73926;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env73927 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__73928 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__73928,"(");
...
var G__73929 = (i + (1));
var G__73930 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env73927;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__73931 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__73931);
...
var G__73932 = cljs.core.next.call(null,s__$1);
var G__73933 = ret;
s__$1 = G__73932;
r = G__73933;
continue;
...
var G__73934 = cljs.core.next.call(null,s);
var G__73935 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__73934;
key_vals = G__73935;
continue;
} else {
...
var gensym_env73939 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env73939;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__73940 = token;
var G__73940__$1 = (((G__73940 == null))?null:cljs.core.subs.call(null,G__73940,(1)));
var G__73940__$2 = (((G__73940__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__73940__$1));
var G__73940__$3 = (((G__73940__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__73940__$2));
var G__73940__$4 = (((G__73940__$3 == null))?null:cljs.core.symbol.call(null,G__73940__$3));
if((G__73940__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__73940__$4);
}
})():(function (){var G__73941 = token;
var G__73941__$1 = (((G__73941 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__73941));
if((G__73941__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__73941__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__73952,reader){
var map__73953 = p__73952;
var map__73953__$1 = ((((!((map__73953 == null)))?(((((map__73953.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73953.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__73953):map__73953);
var opts = map__73953__$1;
var eof = cljs.core.get.call(null,map__73953__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___73961 = arguments.length;
var i__4500__auto___73962 = (0);
while(true){
if((i__4500__auto___73962 < len__4499__auto___73961)){
args__4502__auto__.push((arguments[i__4500__auto___73962]));

var G__73963 = (i__4500__auto___73962 + (1));
i__4500__auto___73962 = G__73963;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq73959){
var G__73960 = cljs.core.first.call(null,seq73959);
var seq73959__$1 = cljs.core.next.call(null,seq73959);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__73960,seq73959__$1);
});


//# sourceMappingURL=reader.js.map?rel=1549004128644
