...
var len__4499__auto___67177 = arguments.length;
var i__4500__auto___67178 = (0);
while(true){
if((i__4500__auto___67178 < len__4499__auto___67177)){
args__4502__auto__.push((arguments[i__4500__auto___67178]));

var G__67179 = (i__4500__auto___67178 + (1));
i__4500__auto___67178 = G__67179;
continue;
} else {
}
break;
...
day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__67174){
var map__67175 = p__67174;
var map__67175__$1 = ((((!((map__67175 == null)))?(((((map__67175.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67175.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67175):map__67175);
var model = cljs.core.get.call(null,map__67175__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.call(null,map__67175__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.call(null,map__67175__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.call(null,map__67175__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
/** @this {Function} */
day8.re_frame_10x.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq67173){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq67173));
});
...
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","set-number-of-retained-epochs","settings/set-number-of-retained-epochs",-1910736736),p1__67180_SHARP_], null));
...
return (function (p1__67181_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__67181_SHARP_], null));
...
});})(i__67188,id,item,c__4290__auto__,size__4291__auto__,b__67189,s__67187__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__67188,id,item,c__4290__auto__,size__4291__auto__,b__67189,s__67187__$2,temp__4657__auto__){
return (function (p1__67182_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__67182_SHARP_], null));
});})(i__67188,id,item,c__4290__auto__,size__4291__auto__,b__67189,s__67187__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__67194 = (i__67188 + (1));
i__67188 = G__67194;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__67189),day8$re_frame_10x$view$settings$render_$_iter__67186.call(null,cljs.core.chunk_rest.call(null,s__67187__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__67189),null);
}
} else {
var item = cljs.core.first.call(null,s__67187__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__67187__$2,temp__4657__auto__){
return (function (){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null));
});})(id,item,s__67187__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__67187__$2,temp__4657__auto__){
return (function (p1__67182_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__67182_SHARP_], null));
});})(id,item,s__67187__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__67186.call(null,cljs.core.rest.call(null,s__67187__$2)));
}
} else {
return null;
}
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4292__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__67190(s__67191){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4290__auto__ = cljs.core.chunk_first.call(null,s__67191__$2);
var size__4291__auto__ = cljs.core.count.call(null,c__4290__auto__);
var b__67193 = cljs.core.chunk_buffer.call(null,size__4291__auto__);
if((function (){var i__67192 = (0);
while(true){
if((i__67192 < size__4291__auto__)){
var item = cljs.core._nth.call(null,c__4290__auto__,i__67192);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__67193,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__67192,id,item,c__4290__auto__,size__4291__auto__,b__67193,s__67191__$2,temp__4657__auto__){
return (function (){
...
});})(i__67192,id,item,c__4290__auto__,size__4291__auto__,b__67193,s__67191__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__67192,id,item,c__4290__auto__,size__4291__auto__,b__67193,s__67191__$2,temp__4657__auto__){
return (function (p1__67183_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__67183_SHARP_], null));
});})(i__67192,id,item,c__4290__auto__,size__4291__auto__,b__67193,s__67191__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__67195 = (i__67192 + (1));
i__67192 = G__67195;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__67193),day8$re_frame_10x$view$settings$render_$_iter__67190.call(null,cljs.core.chunk_rest.call(null,s__67191__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__67193),null);
}
} else {
var item = cljs.core.first.call(null,s__67191__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__67191__$2,temp__4657__auto__){
return (function (){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null));
});})(id,item,s__67191__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__67191__$2,temp__4657__auto__){
return (function (p1__67183_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__67183_SHARP_], null));
});})(id,item,s__67191__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__67190.call(null,cljs.core.rest.call(null,s__67191__$2)));
}
} else {
return null;
}
...
return (function (p1__67184_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__67184_SHARP_], null));
});})(low_level_trace))
...
//# sourceMappingURL=settings.js.map?rel=1548888402831
