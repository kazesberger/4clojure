...
var base_style__$1 = (cljs.core.truth_((function (){var and__3911__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__3911__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__3911__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__68473){
var map__68474 = p__68473;
var map__68474__$1 = ((((!((map__68474 == null)))?(((((map__68474.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68474.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68474):map__68474);
var args = map__68474__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__68474__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__68474,map__68474__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__68470_SHARP_){
return item_renderer.call(null,p1__68470_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__68474,map__68474__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__68474,map__68474__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__68471_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__68471_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__68474,map__68474__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__68474,map__68474__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__68472_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__68472_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__68474,map__68474__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__4499__auto___68483 = arguments.length;
var i__4500__auto___68484 = (0);
while(true){
if((i__4500__auto___68484 < len__4499__auto___68483)){
args__4502__auto__.push((arguments[i__4500__auto___68484]));

var G__68485 = (i__4500__auto___68484 + (1));
i__4500__auto___68484 = G__68485;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__4503__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__68477){
var map__68478 = p__68477;
var map__68478__$1 = ((((!((map__68478 == null)))?(((((map__68478.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68478.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68478):map__68478);
var args = map__68478__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__68478,map__68478__$1,args){
return (function() { 
var G__68486__delegate = function (p__68480){
var map__68481 = p__68480;
...
var G__68486 = function (var_args){
var p__68480 = null;
if (arguments.length > 0) {
var G__68487__i = 0, G__68487__a = new Array(arguments.length -  0);
while (G__68487__i < G__68487__a.length) {G__68487__a[G__68487__i] = arguments[G__68487__i + 0]; ++G__68487__i;}
  p__68480 = new cljs.core.IndexedSeq(G__68487__a,0,null);
} 
return G__68486__delegate.call(this,p__68480);};
G__68486.cljs$lang$maxFixedArity = 0;
G__68486.cljs$lang$applyTo = (function (arglist__68488){
var p__68480 = cljs.core.seq(arglist__68488);
return G__68486__delegate(p__68480);
});
G__68486.cljs$core$IFn$_invoke$arity$variadic = G__68486__delegate;
return G__68486;
})()
;
;})(map__68478,map__68478__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

/** @this {Function} */
re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq68476){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq68476));
});


//# sourceMappingURL=selection_list.js.map?rel=1549004116848
