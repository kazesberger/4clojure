 ...
 */
re_com.input_time.triple__GT_time = (function re_com$input_time$triple__GT_time(p__68406){
var vec__68407 = p__68406;
var hr = cljs.core.nth.call(null,vec__68407,(0),null);
var _ = cljs.core.nth.call(null,vec__68407,(1),null);
var mi = cljs.core.nth.call(null,vec__68407,(2),null);
return ((hr * (100)) + mi);
});
...
if(cljs.core.truth_((function (){var and__3911__auto__ = typeof model === 'number';
...
if(cljs.core.truth_((function (){var and__3911__auto__ = typeof minimum === 'number';
if(and__3911__auto__){
...
if(cljs.core.truth_((function (){var and__3911__auto__ = typeof maximum === 'number';
if(and__3911__auto__){
...
if(cljs.core.truth_((function (){var and__3911__auto__ = callback;
...
var len__4499__auto___68417 = arguments.length;
var i__4500__auto___68418 = (0);
while(true){
if((i__4500__auto___68418 < len__4499__auto___68417)){
args__4502__auto__.push((arguments[i__4500__auto___68418]));

var G__68419 = (i__4500__auto___68418 + (1));
i__4500__auto___68418 = G__68419;
continue;
} else {
}
break;
...
return re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic(argseq__4503__auto__);
});

re_com.input_time.input_time.cljs$core$IFn$_invoke$arity$variadic = (function (p__68411){
var map__68412 = p__68411;
var map__68412__$1 = ((((!((map__68412 == null)))?(((((map__68412.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68412.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68412):map__68412);
var args = map__68412__$1;
var model = cljs.core.get.call(null,map__68412__$1,new cljs.core.Keyword(null,"model","model",331153215));
var minimum = cljs.core.get.call(null,map__68412__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059),(0));
var maximum = cljs.core.get.call(null,map__68412__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714),(2359));
...
return ((function (deref_model,text_model,previous_model,map__68412,map__68412__$1,args,model,minimum,maximum){
return (function() { 
var G__68420__delegate = function (p__68414){
var map__68415 = p__68414;
var map__68415__$1 = ((((!((map__68415 == null)))?(((((map__68415.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68415.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68415):map__68415);
var args__$1 = map__68415__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var model__$1 = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var hide_border_QMARK_ = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var maximum__$1 = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714),(2359));
var width = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var style = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var show_icon_QMARK_ = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"show-icon?","show-icon?",-756836459));
var minimum__$1 = cljs.core.get.call(null,map__68415__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059),(0));
...
,new cljs.core.Keyword(null,"on-key-up","on-key-up",884441808),((function (style__$1,new_val,new_val__$1,new_val__$2,map__68415,map__68415__$1,args__$1,disabled_QMARK_,on_change,height,model__$1,attr,hide_border_QMARK_,maximum__$1,width,style,class$,show_icon_QMARK_,minimum__$1,deref_model,text_model,previous_model,map__68412,map__68412__$1,args,model,minimum,maximum){
return (function (event){
...
var G__68420 = function (var_args){
var p__68414 = null;
if (arguments.length > 0) {
var G__68421__i = 0, G__68421__a = new Array(arguments.length -  0);
while (G__68421__i < G__68421__a.length) {G__68421__a[G__68421__i] = arguments[G__68421__i + 0]; ++G__68421__i;}
  p__68414 = new cljs.core.IndexedSeq(G__68421__a,0,null);
} 
return G__68420__delegate.call(this,p__68414);};
G__68420.cljs$lang$maxFixedArity = 0;
G__68420.cljs$lang$applyTo = (function (arglist__68422){
var p__68414 = cljs.core.seq(arglist__68422);
return G__68420__delegate(p__68414);
});
G__68420.cljs$core$IFn$_invoke$arity$variadic = G__68420__delegate;
return G__68420;
})()
;
;})(deref_model,text_model,previous_model,map__68412,map__68412__$1,args,model,minimum,maximum))
});

re_com.input_time.input_time.cljs$lang$maxFixedArity = (0);

/** @this {Function} */
re_com.input_time.input_time.cljs$lang$applyTo = (function (seq68410){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq68410));
});


//# sourceMappingURL=input_time.js.map?rel=1549004116604
