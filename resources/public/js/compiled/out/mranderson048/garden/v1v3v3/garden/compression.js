 ...
 */
mranderson048.garden.v1v3v3.garden.compression.token_fn = (function mranderson048$garden$v1v3v3$garden$compression$token_fn(p__66314){
var vec__66315 = p__66314;
var tag = cljs.core.nth.call(null,vec__66315,(0),null);
var re = cljs.core.nth.call(null,vec__66315,(1),null);
return ((function (vec__66315,tag,re){
return (function (s){
...
var len__4499__auto___66320 = arguments.length;
var i__4500__auto___66321 = (0);
while(true){
if((i__4500__auto___66321 < len__4499__auto___66320)){
args__4502__auto__.push((arguments[i__4500__auto___66321]));

var G__66322 = (i__4500__auto___66321 + (1));
i__4500__auto___66321 = G__66322;
continue;
} else {
}
break;
...
return (function (p1__66318_SHARP_){
return p1__66318_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
mranderson048.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq66319){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq66319));
});
...
var map__66323 = temp__4655__auto__;
var map__66323__$1 = ((((!((map__66323 == null)))?(((((map__66323.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66323.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__66323):map__66323);
var tag = cljs.core.get.call(null,map__66323__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__66323__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__66323__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__66326 = cljs.core.subs.call(null,s1,size);
var G__66327 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__66325 = tag;
var G__66325__$1 = (((G__66325 instanceof cljs.core.Keyword))?G__66325.fqn:null);
switch (G__66325__$1) {
case "string":
return chunk;
...
//# sourceMappingURL=compression.js.map?rel=1548888401385
