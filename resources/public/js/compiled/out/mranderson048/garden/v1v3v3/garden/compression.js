 ...
 */
mranderson048.garden.v1v3v3.garden.compression.token_fn = (function mranderson048$garden$v1v3v3$garden$compression$token_fn(p__81890){
var vec__81891 = p__81890;
var tag = cljs.core.nth.call(null,vec__81891,(0),null);
var re = cljs.core.nth.call(null,vec__81891,(1),null);
return ((function (vec__81891,tag,re){
return (function (s){
...
var len__4499__auto___81896 = arguments.length;
var i__4500__auto___81897 = (0);
while(true){
if((i__4500__auto___81897 < len__4499__auto___81896)){
args__4502__auto__.push((arguments[i__4500__auto___81897]));

var G__81898 = (i__4500__auto___81897 + (1));
i__4500__auto___81897 = G__81898;
continue;
} else {
}
break;
...
return (function (p1__81894_SHARP_){
return p1__81894_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
mranderson048.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq81895){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq81895));
});
...
var map__81899 = temp__4655__auto__;
var map__81899__$1 = ((((!((map__81899 == null)))?(((((map__81899.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__81899.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__81899):map__81899);
var tag = cljs.core.get.call(null,map__81899__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__81899__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__81899__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__81902 = cljs.core.subs.call(null,s1,size);
var G__81903 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__81901 = tag;
var G__81901__$1 = (((G__81901 instanceof cljs.core.Keyword))?G__81901.fqn:null);
switch (G__81901__$1) {
case "string":
return chunk;
...
//# sourceMappingURL=compression.js.map?rel=1549004149668
