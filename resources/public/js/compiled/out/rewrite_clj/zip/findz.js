...
var len__4499__auto___79159 = arguments.length;
var i__4500__auto___79160 = (0);
while(true){
if((i__4500__auto___79160 < len__4499__auto___79159)){
args__4502__auto__.push((arguments[i__4500__auto___79160]));

var G__79161 = (i__4500__auto___79160 + (1));
i__4500__auto___79160 = G__79161;
continue;
} else {
}
break;
...
rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__79155){
var vec__79156 = p__79155;
var additional = cljs.core.nth.call(null,vec__79156,(0),null);
if(cljs.core.truth_(additional)){
return ((function (vec__79156,additional){
...
;})(vec__79156,additional))
} else {
return ((function (vec__79156,additional){
return (function (p1__79152_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__79152_SHARP_),t);
});
;})(vec__79156,additional))
}
});
...
/** @this {Function} */
rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq79153){
var G__79154 = cljs.core.first.call(null,seq79153);
var seq79153__$1 = cljs.core.next.call(null,seq79153);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__79154,seq79153__$1);
});

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__79162,p__79163){
var map__79164 = p__79162;
var map__79164__$1 = ((((!((map__79164 == null)))?(((((map__79164.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__79164.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__79164):map__79164);
var row = cljs.core.get.call(null,map__79164__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.call(null,map__79164__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.call(null,map__79164__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.call(null,map__79164__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__79165 = p__79163;
var map__79165__$1 = ((((!((map__79165 == null)))?(((((map__79165.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__79165.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__79165):map__79165);
var r = cljs.core.get.call(null,map__79165__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.call(null,map__79165__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last.call(null,cljs.core.filter.call(null,(function (p1__79171_SHARP_){
var and__3911__auto__ = p_QMARK_.call(null,p1__79171_SHARP_);
if(cljs.core.truth_(and__3911__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_.call(null,cljs.core.meta.call(null,clojure.zip.node.call(null,p1__79171_SHARP_)),pos);
} else {
return and__3911__auto__;
}
...
var G__79177 = zloc;
var G__79177__$1 = (((G__79177 == null))?null:f.call(null,G__79177));
if((G__79177__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.call(null,G__79177__$1,f,p_QMARK_);
}
});
...
return rewrite_clj.zip.findz.find.call(null,zloc,f,(function (p1__79179_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__79179_SHARP_),t);
}));
});
...
return rewrite_clj.zip.findz.find_last_by_pos.call(null,zloc,pos,(function (p1__79186_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__79186_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_.call(null,v))?cljs.core.comp.call(null,v,rewrite_clj.zip.base.sexpr):(function (p1__79193_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.sexpr.call(null,p1__79193_SHARP_),v);
}));
...
//# sourceMappingURL=findz.js.map?rel=1549004142390
