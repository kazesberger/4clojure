...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__74466_SHARP_){
var _STAR_delimiter_STAR_74467 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = delimiter;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__74466_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR_74467;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4502__auto__ = [];
var len__4499__auto___74476 = arguments.length;
var i__4500__auto___74477 = (0);
while(true){
if((i__4500__auto___74477 < len__4499__auto___74476)){
args__4502__auto__.push((arguments[i__4500__auto___74477]));

var G__74478 = (i__4500__auto___74477 + (1));
i__4500__auto___74477 = G__74478;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__74472){
var vec__74473 = p__74472;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__74473,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq74468){
var G__74469 = cljs.core.first.call(null,seq74468);
var seq74468__$1 = cljs.core.next.call(null,seq74468);
var G__74470 = cljs.core.first.call(null,seq74468__$1);
var seq74468__$2 = cljs.core.next.call(null,seq74468__$1);
var G__74471 = cljs.core.first.call(null,seq74468__$2);
var seq74468__$3 = cljs.core.next.call(null,seq74468__$2);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74469,G__74470,G__74471,seq74468__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__74479 = rewrite_clj.reader.peek.call(null,reader);
switch (G__74479) {
case "(":
...
var G__74481 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__74481)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"{",G__74481)){
...
if(cljs.core._EQ_.call(null,"_",G__74481)){
...
//# sourceMappingURL=core.js.map?rel=1549004131479
