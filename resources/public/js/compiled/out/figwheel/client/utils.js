...
return (new CustomEvent(event_name,(function (){var obj89317 = {"detail":data};
return obj89317;
})()));
} else {
...
var f = (function (){var pred__89324 = cljs.core._EQ_;
var expr__89325 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__89324.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__89325))){
return ((function (pred__89324,expr__89325){
return (function (p1__89318_SHARP_){
return console.warn(p1__89318_SHARP_);
});
;})(pred__89324,expr__89325))
} else {
if(cljs.core.truth_(pred__89324.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__89325))){
return ((function (pred__89324,expr__89325){
return (function (p1__89319_SHARP_){
return console.debug(p1__89319_SHARP_);
});
;})(pred__89324,expr__89325))
} else {
if(cljs.core.truth_(pred__89324.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__89325))){
return ((function (pred__89324,expr__89325){
return (function (p1__89320_SHARP_){
return console.error(p1__89320_SHARP_);
});
;})(pred__89324,expr__89325))
} else {
return ((function (pred__89324,expr__89325){
return (function (p1__89321_SHARP_){
return console.log(p1__89321_SHARP_);
});
;})(pred__89324,expr__89325))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__89328){
var map__89329 = p__89328;
var map__89329__$1 = ((((!((map__89329 == null)))?(((((map__89329.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__89329.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__89329):map__89329);
var opts = map__89329__$1;
var eval_fn = cljs.core.get.call(null,map__89329__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__89331_SHARP_){
return new_def.callback(p1__89331_SHARP_);
});})(new_def))
);
...
return (function (p__89332){
var vec__89333 = p__89332;
var ky = cljs.core.nth.call(null,vec__89333,(0),null);
var v = cljs.core.nth.call(null,vec__89333,(1),null);
...
}catch (e89338){if((e89338 instanceof Error)){
var e = e89338;
return not_found;
} else {
throw e89338;
...
//# sourceMappingURL=utils.js.map?rel=1549004161751
