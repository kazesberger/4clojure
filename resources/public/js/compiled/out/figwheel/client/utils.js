...
return (new CustomEvent(event_name,(function (){var obj67890 = {"detail":data};
return obj67890;
})()));
} else {
...
var f = (function (){var pred__67897 = cljs.core._EQ_;
var expr__67898 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__67897.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__67898))){
return ((function (pred__67897,expr__67898){
return (function (p1__67891_SHARP_){
return console.warn(p1__67891_SHARP_);
});
;})(pred__67897,expr__67898))
} else {
if(cljs.core.truth_(pred__67897.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__67898))){
return ((function (pred__67897,expr__67898){
return (function (p1__67892_SHARP_){
return console.debug(p1__67892_SHARP_);
});
;})(pred__67897,expr__67898))
} else {
if(cljs.core.truth_(pred__67897.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__67898))){
return ((function (pred__67897,expr__67898){
return (function (p1__67893_SHARP_){
return console.error(p1__67893_SHARP_);
});
;})(pred__67897,expr__67898))
} else {
return ((function (pred__67897,expr__67898){
return (function (p1__67894_SHARP_){
return console.log(p1__67894_SHARP_);
});
;})(pred__67897,expr__67898))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__67901){
var map__67902 = p__67901;
var map__67902__$1 = ((((!((map__67902 == null)))?(((((map__67902.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67902.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67902):map__67902);
var opts = map__67902__$1;
var eval_fn = cljs.core.get.call(null,map__67902__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__67904_SHARP_);
});})(new_def))
);
...
return (function (p__67905){
var vec__67906 = p__67905;
var ky = cljs.core.nth.call(null,vec__67906,(0),null);
var v = cljs.core.nth.call(null,vec__67906,(1),null);
...
}catch (e67911){if((e67911 instanceof Error)){
var e = e67911;
return not_found;
} else {
throw e67911;
...
//# sourceMappingURL=utils.js.map?rel=1548888404558
