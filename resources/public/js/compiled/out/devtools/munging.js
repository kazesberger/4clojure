...
var o61985 = temp__4655__auto__;
var temp__4655__auto____$1 = (o61985["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o61986 = temp__4655__auto____$1;
return (o61986["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__61129__auto__ = f;
return (o__61129__auto__["toString"]).call(o__61129__auto__);
} else {
return "";
}
}catch (e61987){var _ = e61987;
return "";
}});
...
try{var o__61129__auto___61989 = t;
(o__61129__auto___61989["cljs$lang$ctorPrWriter"]).call(o__61129__auto___61989,t,writer);
}catch (e61988){var __61990 = e61988;
}
...
var char_code = (function (){var o__61129__auto__ = (new String(char$));
return (o__61129__auto__["charCodeAt"]).call(o__61129__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__61129__auto__ = String;
return (o__61129__auto__["fromCharCode"]).call(o__61129__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__61991 = num_code;
switch (G__61991) {
case (1):
return (185);
...
var o__61129__auto__ = String;
return (o__61129__auto__["fromCharCode"]).call(o__61129__auto__,superscript_code);
});
/**
...
}catch (e61993){var _e__61136__auto__ = e61993;
return false;
}})())){
...
var vec__61994 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__61994,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o61997 = temp__4655__auto__;
var temp__4655__auto____$1 = (o61997["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o61998 = temp__4655__auto____$1;
return (o61998["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___62005 = arguments.length;
var i__4500__auto___62006 = (0);
while(true){
if((i__4500__auto___62006 < len__4499__auto___62005)){
args__4502__auto__.push((arguments[i__4500__auto___62006]));

var G__62007 = (i__4500__auto___62006 + (1));
i__4500__auto___62006 = G__62007;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__62001){
var vec__62002 = p__62001;
var ns_detector = cljs.core.nth.call(null,vec__62002,(0),null);
...
var G__62008 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__62009 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__62008;
remaining_tokens = G__62009;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq61999){
var G__62000 = cljs.core.first.call(null,seq61999);
var seq61999__$1 = cljs.core.next.call(null,seq61999);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62000,seq61999__$1);
});
...
var vec__62013 = cljs.core.split_with.call(null,(function (p1__62012_SHARP_){
return cljs.core.not_EQ_.call(null,p1__62012_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__62013,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__62013,(1),null);
...
var vec__62016 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__62016,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__62016,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__62019 = cljs.core.rest.call(null,remaining_tokens);
var G__62020 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__62019;
name_tokens = G__62020;
continue;
} else {
...
var vec__62023 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__62023,(0),null);
var arity = cljs.core.nth.call(null,vec__62023,(1),null);
var vec__62026 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__62026,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__62026,(1),null);
var vec__62029 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__62029,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__62029,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__62029,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__62029,(3),null);
...
var vec__62035 = result;
var munged_ns = cljs.core.nth.call(null,vec__62035,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__62035,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__62035,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__62035,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__62035,(4),null);
var arity = cljs.core.nth.call(null,vec__62035,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__62039 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__62039,(0),null);
var args = cljs.core.nth.call(null,vec__62039,(1),null);
var vec__62042 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__62042,(0),null);
var name = cljs.core.nth.call(null,vec__62042,(1),null);
...
var G__62045 = (arity + (1));
var G__62046 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__62047){
var vec__62048 = p__62047;
var arity = cljs.core.nth.call(null,vec__62048,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__62048,(1),null);
...
return cljs.core.get.call(null,arities,p1__62051_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__62052_SHARP_){
return cljs.core.drop.call(null,(2),p1__62052_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___62059 = arguments.length;
var i__4500__auto___62060 = (0);
while(true){
if((i__4500__auto___62060 < len__4499__auto___62059)){
args__4502__auto__.push((arguments[i__4500__auto___62060]));

var G__62061 = (i__4500__auto___62060 + (1));
i__4500__auto___62060 = G__62061;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__62055){
var vec__62056 = p__62055;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__62056,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq62053){
var G__62054 = cljs.core.first.call(null,seq62053);
var seq62053__$1 = cljs.core.next.call(null,seq62053);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62054,seq62053__$1);
});
...
var map__62064 = options;
var map__62064__$1 = ((((!((map__62064 == null)))?(((((map__62064.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62064.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62064):map__62064);
var include_ns_QMARK_ = cljs.core.get.call(null,map__62064__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__62064__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__62064__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__62064__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__62065 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__62065,(0),null);
var fn_name = cljs.core.nth.call(null,vec__62065,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__62065,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__62065,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__62065,(4),null);
var arity = cljs.core.nth.call(null,vec__62065,(5),null);
...
var o__61129__auto__ = f;
return (o__61129__auto__["getBasis"]).call(o__61129__auto__);
});
/**
...
}catch (e62069){var _e__61136__auto__ = e62069;
...
var G__62070 = (obj[cljs.core.first.call(null,path)]);
var G__62071 = cljs.core.rest.call(null,path);
obj = G__62070;
path = G__62071;
continue;
} else {
...
return (function (accum,p__62072){
var vec__62073 = p__62072;
var bit = cljs.core.nth.call(null,vec__62073,(0),null);
var protocol = cljs.core.nth.call(null,vec__62073,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__62076){
var vec__62077 = p__62076;
var ns = cljs.core.nth.call(null,vec__62077,(0),null);
var name = cljs.core.nth.call(null,vec__62077,(1),null);
var selector = cljs.core.nth.call(null,vec__62077,(2),null);
...
return (function (p__62081){
var vec__62082 = p__62081;
var munged_name = cljs.core.nth.call(null,vec__62082,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__62082,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__62082,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__62080_SHARP_){
return (obj[cljs.core.first.call(null,p1__62080_SHARP_)]);
});})(name,sorted_matches,vec__62082,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1548888392261
