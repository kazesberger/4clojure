...
var o70387 = temp__4655__auto__;
var temp__4655__auto____$1 = (o70387["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o70388 = temp__4655__auto____$1;
return (o70388["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__69351__auto__ = f;
return (o__69351__auto__["toString"]).call(o__69351__auto__);
} else {
return "";
}
}catch (e70389){var _ = e70389;
return "";
}});
...
try{var o__69351__auto___70391 = t;
(o__69351__auto___70391["cljs$lang$ctorPrWriter"]).call(o__69351__auto___70391,t,writer);
}catch (e70390){var __70392 = e70390;
}
...
var char_code = (function (){var o__69351__auto__ = (new String(char$));
return (o__69351__auto__["charCodeAt"]).call(o__69351__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__69351__auto__ = String;
return (o__69351__auto__["fromCharCode"]).call(o__69351__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__70393 = num_code;
switch (G__70393) {
case (1):
return (185);
...
var o__69351__auto__ = String;
return (o__69351__auto__["fromCharCode"]).call(o__69351__auto__,superscript_code);
});
/**
...
}catch (e70395){var _e__69358__auto__ = e70395;
return false;
}})())){
...
var vec__70396 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__70396,(0),null);
...
var or__3922__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o70399 = temp__4655__auto__;
var temp__4655__auto____$1 = (o70399["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o70400 = temp__4655__auto____$1;
return (o70400["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___70407 = arguments.length;
var i__4500__auto___70408 = (0);
while(true){
if((i__4500__auto___70408 < len__4499__auto___70407)){
args__4502__auto__.push((arguments[i__4500__auto___70408]));

var G__70409 = (i__4500__auto___70408 + (1));
i__4500__auto___70408 = G__70409;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__70403){
var vec__70404 = p__70403;
var ns_detector = cljs.core.nth.call(null,vec__70404,(0),null);
...
var G__70410 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__70411 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__70410;
remaining_tokens = G__70411;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq70401){
var G__70402 = cljs.core.first.call(null,seq70401);
var seq70401__$1 = cljs.core.next.call(null,seq70401);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70402,seq70401__$1);
});
...
var vec__70415 = cljs.core.split_with.call(null,(function (p1__70414_SHARP_){
return cljs.core.not_EQ_.call(null,p1__70414_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__70415,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__70415,(1),null);
...
var vec__70418 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__70418,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__70418,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__70421 = cljs.core.rest.call(null,remaining_tokens);
var G__70422 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__70421;
name_tokens = G__70422;
continue;
} else {
...
var vec__70425 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__70425,(0),null);
var arity = cljs.core.nth.call(null,vec__70425,(1),null);
var vec__70428 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__70428,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__70428,(1),null);
var vec__70431 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__70431,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__70431,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__70431,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__70431,(3),null);
...
var vec__70437 = result;
var munged_ns = cljs.core.nth.call(null,vec__70437,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__70437,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__70437,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__70437,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__70437,(4),null);
var arity = cljs.core.nth.call(null,vec__70437,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__70441 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__70441,(0),null);
var args = cljs.core.nth.call(null,vec__70441,(1),null);
var vec__70444 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__70444,(0),null);
var name = cljs.core.nth.call(null,vec__70444,(1),null);
...
var G__70447 = (arity + (1));
var G__70448 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__70449){
var vec__70450 = p__70449;
var arity = cljs.core.nth.call(null,vec__70450,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__70450,(1),null);
...
return cljs.core.get.call(null,arities,p1__70453_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__70454_SHARP_){
return cljs.core.drop.call(null,(2),p1__70454_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___70461 = arguments.length;
var i__4500__auto___70462 = (0);
while(true){
if((i__4500__auto___70462 < len__4499__auto___70461)){
args__4502__auto__.push((arguments[i__4500__auto___70462]));

var G__70463 = (i__4500__auto___70462 + (1));
i__4500__auto___70462 = G__70463;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__70457){
var vec__70458 = p__70457;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__70458,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq70455){
var G__70456 = cljs.core.first.call(null,seq70455);
var seq70455__$1 = cljs.core.next.call(null,seq70455);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70456,seq70455__$1);
});
...
var map__70466 = options;
var map__70466__$1 = ((((!((map__70466 == null)))?(((((map__70466.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70466.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__70466):map__70466);
var include_ns_QMARK_ = cljs.core.get.call(null,map__70466__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__70466__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__70466__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__70466__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__70467 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__70467,(0),null);
var fn_name = cljs.core.nth.call(null,vec__70467,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__70467,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__70467,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__70467,(4),null);
var arity = cljs.core.nth.call(null,vec__70467,(5),null);
...
var o__69351__auto__ = f;
return (o__69351__auto__["getBasis"]).call(o__69351__auto__);
});
/**
...
}catch (e70471){var _e__69358__auto__ = e70471;
...
var G__70472 = (obj[cljs.core.first.call(null,path)]);
var G__70473 = cljs.core.rest.call(null,path);
obj = G__70472;
path = G__70473;
continue;
} else {
...
return (function (accum,p__70474){
var vec__70475 = p__70474;
var bit = cljs.core.nth.call(null,vec__70475,(0),null);
var protocol = cljs.core.nth.call(null,vec__70475,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__70478){
var vec__70479 = p__70478;
var ns = cljs.core.nth.call(null,vec__70479,(0),null);
var name = cljs.core.nth.call(null,vec__70479,(1),null);
var selector = cljs.core.nth.call(null,vec__70479,(2),null);
...
return (function (p__70483){
var vec__70484 = p__70483;
var munged_name = cljs.core.nth.call(null,vec__70484,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__70484,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__70484,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__70482_SHARP_){
return (obj[cljs.core.first.call(null,p1__70482_SHARP_)]);
});})(name,sorted_matches,vec__70484,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1549004121372
