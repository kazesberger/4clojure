...
var len__4499__auto___62116 = arguments.length;
var i__4500__auto___62117 = (0);
while(true){
if((i__4500__auto___62117 < len__4499__auto___62116)){
args__4502__auto__.push((arguments[i__4500__auto___62117]));

var G__62118 = (i__4500__auto___62117 + (1));
i__4500__auto___62117 = G__62118;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq62113){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62114,G__62115,seq62113__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__62119_SHARP_){
return !((cljs.core.meta.call(null,p1__62119_SHARP_) == null));
})))){
...
var map__62120 = opts;
var map__62120__$1 = ((((!((map__62120 == null)))?(((((map__62120.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62120.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62120):map__62120);
var markup_db = cljs.core.get.call(null,map__62120__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e62124){var _e__61136__auto__ = e62124;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e62126){var _e__61136__auto__ = e62126;
return false;
}}
})())){
...
var _STAR_current_state_STAR_62128 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__62129 = opts;
...
var markup_db = cljs.core.get.call(null,map__62129__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_62128;
}});
...
;
var temp__4655__auto___62133 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___62133)){
var managed_print_level_62134 = temp__4655__auto___62133;
var _STAR_print_level_STAR_62132_62135 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_62134;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_62132_62135,managed_print_level_62134,temp__4655__auto___62133,writer,opts,job_fn){
return (function (p1__62131_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__62131_SHARP_,null);
});})(_STAR_print_level_STAR_62132_62135,managed_print_level_62134,temp__4655__auto___62133,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_62132_62135;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1548888392447
